...
import StylizedLogoMark from "./StylisedLogoMark";
        ...
        <div className="mt-20 flex flex-col items-center md:flex-row">
          {slice.items.map((item, index) => (
            <React.Fragment key={index}>
              ...
              <div className="pulsing-icon text-vlue-100 flex aspect-square shrink-0 items-center justify-center rounded-full border border-blue-50/30 bg-blue-50/25 p-3 text-3xl opacity-40 md:text-4xl lg:text-5xl">
